# Додайте до банкомату меню отримання поточного курсу валют за допомогою
...
class CashMachine:
    ...
    def get_current_exchange_rate():
        ...
        # date_now = "04.12.2023"
        response = requests.get(f"https://api.privatbank.ua/p24api/exchange_rates?date={date_now}")
        ...
        if exchange_rate_list:
            ...
            for rate in exchange_rate_list:
                if rate["currency"] in target_currencies:
                    print(rate["currency"])
