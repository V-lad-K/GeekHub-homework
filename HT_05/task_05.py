...
# операцiя, яку зробити! Аргументи брати від юзера (можна по одному - 2, окремо +, окремо 2; можна всі разом - типу 1 + 2).
...
operand1 = float(input("input operand1 "))
operand2 = float(input("input operand2 "))
