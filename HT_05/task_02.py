...
# результат математичної операції тощо). Також створiть четверту ф-цiю, яка всередині викликає 3 попереднi,
...
def general(number1, number2):
    return addition(number1, number2) + subtraction(number1, number2) + multiplication(number1, number2)
